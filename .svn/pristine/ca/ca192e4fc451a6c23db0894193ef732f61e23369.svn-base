package com.benwunet.mws.commons.result;
...
public class RequestResult<T> implements Serializable {
    ...
    public static RequestResult ok(Object data){
        return new RequestResult(ResultCode.SUCCESS.getCode(), ResultCode.SUCCESS.getMessage(), data);
    }
    public static RequestResult ok(String msg, Object data){
        return new RequestResult(ResultCode.SUCCESS.getCode(), msg, data);
    }
    /**
     * @Auther: WangLin
     * @Date: 2019/7/9 16:13
    ...
    public static RequestResult error(ResultCode code){
