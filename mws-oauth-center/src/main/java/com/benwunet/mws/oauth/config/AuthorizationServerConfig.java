...
import com.benwunet.mws.oauth.service.Impl.RandomAuthenticationKeyGenerator;
import com.benwunet.mws.oauth.service.Impl.RedisAuthorizationCodeServices;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    private void addLoginUserInfo(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        if (accessToken instanceof DefaultOAuth2AccessToken) {
            ...
            if (principal instanceof LoginPubSysUser) {
                LoginPubSysUser loginPubSysUser = (LoginPubSysUser) principal;
                /**旧的附加参数*/
                Map<String, Object> map = new HashMap<>(defaultOAuth2AccessToken.getAdditionalInformation());
                /**追加当前登陆用户*/
                map.put("loginPubSysUser", loginPubSysUser);
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        /**优化redisClientDetailsService这个实现类*/
