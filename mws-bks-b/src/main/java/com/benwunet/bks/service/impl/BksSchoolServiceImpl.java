...
public class BksSchoolServiceImpl extends ServiceImpl<BksSchoolDao, BksSchool> implements BksSchoolService {
    ...
    @Override
    public List<BksSchoolDTO> getSchoolHeat(Integer page,Integer size) {
        return  bksSchoolDao.getSchoolHeat(page,size);
    }

    @Override
    public int getSchoolHeatcount() {
        return bksSchoolDao.getSchoolHeatcount();
    }
