...
public class MD5Utils {
    ...
    public static String saltMD5(String mobile, String password) {
        String Salt = "benwu" + mobile;
        password = md5Hex(password + Salt);
        char[] cs = new char[48];
        for (int i = 0; i < 48; i += 3) {
            cs[i] = password.charAt(i / 3 * 2);
...
//        }
//        String saltMD5 = MD5Utils.saltMD5 ( "15923042732","123456");
//        System.out.println (saltMD5);
        String saltMD5 = getSaltMD5 ("1");
        System.out.println (saltMD5);
    }
